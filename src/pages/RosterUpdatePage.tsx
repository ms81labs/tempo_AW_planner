...
import { Search, Plus, Star, Shield } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
...
const RosterUpdatePage = () => {
  ...
  // Fetch member info, champions and user champions on component mount
  useEffect(() => {
    if (!memberId) return;
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        setMemberName(memberData.ingame_name);
  ...
  const handleAddChampion = async () => {
    if (!memberId || !newChampionId) return;
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-center mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold">MCOC Alliance War</h1>
            <p className="text-sm text-muted-foreground">
              Champion Roster Update
            </p>
          </div>
        </div>

        <Card className="w-full bg-white overflow-hidden flex flex-col mb-6">
          <CardHeader className="pb-2 border-b">
            <div className="flex justify-between items-center">
              <CardTitle className="text-xl">
                {memberName}'s Champion Roster
              </CardTitle>
              <div className="flex items-center gap-2">
                ...
                <Select
                  value={selectedRank}
                  onValueChange={(value) =>
                    setSelectedRank(value as ChampionRank)
                  }
                >
                  ...
                  {filteredUserChampions.length > 0 ? (
                    ...
                    <div className="bg-gray-50 p-4 rounded-md text-center">
                      <p className="text-gray-500">
                        No {selectedRarity} champions in your collection. Add
                        some champions!
                      </p>
                    </div>
                  )}
                      ...
                      >
                        <div className="flex flex-col items-start gap-1">
                          <Badge
                            ...
                            className={
                              classColors[
                                championClass as keyof typeof classColors
                              ]
                            }
                          >
                            {championClass.charAt(0).toUpperCase() +
        ...
        <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
          <DialogContent>
            ...
            <div className="grid gap-4 py-4">
              <div className="flex items-center justify-center mb-2">
                <div className="text-center">
                  <h3 className="font-medium text-lg">{newChampionName}</h3>
                  <Badge
                    variant="secondary"
                    className={
                      classColors[newChampionClass as keyof typeof classColors]
                    }
                  >
                    {newChampionClass.charAt(0).toUpperCase() +
                      newChampionClass.slice(1)}
                  </Badge>
                </div>
              </div>
            ...
            <DialogFooter>
              <Button type="submit" onClick={handleAddChampion}>
                Add to Collection
              </Button>
            </DialogFooter>
          </DialogContent>
...
export default RosterUpdatePage;
